...
export const MOCK_EVENTS: CommunityEvent[] = [
  {
    ...
    radiusMeters: 200,
    participants: [
      { userId: 'u1', userName: 'Donfack Arthur', status: 'approved', joinedAt: '2026-04-18T10:00:00Z', ecoPointsEarned: 180 },
      { userId: 'u2', userName: 'Marie Nguemo', status: 'approved', joinedAt: '2026-04-18T10:05:00Z', ecoPointsEarned: 165 },
      { userId: 'u3', userName: 'Jean-Paul Kamga', status: 'approved', joinedAt: '2026-04-19T08:00:00Z', ecoPointsEarned: 150 },
    ],
  ...
  },
  {
    ...
    radiusMeters: 300,
    participants: [
      { userId: 'u4', userName: 'Aminata Diallo', status: 'approved', joinedAt: '2026-04-29T14:00:00Z', ecoPointsEarned: 0 },
      { userId: 'u5', userName: 'Paul Essomba', status: 'pending', joinedAt: '2026-04-29T15:00:00Z', ecoPointsEarned: 0 },
      { userId: 'u6', userName: 'Franck Biya', status: 'pending', joinedAt: '2026-04-30T10:00:00Z', ecoPointsEarned: 0 },
    ],
